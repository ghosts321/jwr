...
$(function(){
 ...
 var types = '${pnRegInfo.type}';
 document.getElementById("pnRegInfo.type").value=types;
 var edu = '${pnRegInfo.edu}';
 document.getElementById("pnRegInfo.edu").value=edu;
 showMot(types);
})
...
<body>
	...
	<center style="border: 1px solid #369">
		<h1
			style="padding:20px; background-color:#369; color: white; font-size: 22px; margin-top:0px">考评员报名申请信息修改</h1>
		<div align="left">
			<div class="eui-info">
		...
		<div align="center" style="border:0px solid red">
			...
			<form id="fm1" method="POST" action="<%=basePath%>/reg/updatepnregAction.action">
				<input type="hidden" id="" name="pnRegInfo.id" value="${pnRegInfo.id }"/>
				<table style="margin-left: 30px">
					<caption style="padding: 5px;">
						<h1 align="center">考评员报名申请信息修改</h1>
					</caption>
					<tbody>
						<tr>
							<td
						...
						<tr>
							<td
								style="font-family:微软雅黑;font-size:14px;vertical-align:center;height:35px;border-bottom:1px dotted gray"><label
								title="考评员申请的专业类型不得多于二种">申请专业类型：</label></td>
							<td style="border-bottom:1px dotted gray">
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input readonly="readonly"
								class="easyui-validatebox validatebox-text" onchange="queryUserId()"
								id="orgRegInfo.userid" name="pnRegInfo.userid" required="true" value="${pnRegInfo.userid }"
								type="text"></td>
							<td><font color="red">*</font></td>
						</tr>
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="pnRegInfo.username" value="${pnRegInfo.username }"
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input readonly="readonly"
								class="easyui-validatebox validatebox-text" id="pnRegInfo.pid" name="pnRegInfo.pid" onchange="querypid()" value="${pnRegInfo.pid }"
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="pnRegInfo.org" name="pnRegInfo.org" value="${pnRegInfo.org }"
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="pnRegInfo.title" value="${pnRegInfo.title }"
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="pnRegInfo.tel" name="pnRegInfo.tel" value="${pnRegInfo.tel }"
								type="text"></td>
							<td><font color="red">*</font></td>
						</tr>
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="pnRegInfo.fax" name="pnRegInfo.fax" value="${pnRegInfo.fax }"
								type="text"></td>
							<td><font color="lightgray">*</font></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="pnRegInfo.major" value="${pnRegInfo.major}"
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="pnRegInfo.prof" value="${pnRegInfo.prof }"
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input 
								...
								name="pnRegInfo.begindate" required="true" type="text" value="${pnRegInfo.begindate }"></td>
							<td><font color="red">*</font></td>
						</tr>
						<tr>
							<td
							...
							<td style="border-bottom:1px dotted gray"><textarea
									...
									name="pnRegInfo.train" required="true">${pnRegInfo.train }</textarea></td>
							<td><font color="red">*</font></td>
						</tr>
						<tr>
							<td
							...
							<td style="border-bottom:1px dotted gray"><textarea
									...
									name="pnRegInfo.resume" required="true">${pnRegInfo.resume }</textarea></td>
							<td><font color="red">*</font></td>
						</tr>
						<tr>
							<td
							...
							<td style="border-bottom:1px dotted gray"><textarea
									...
									name="pnRegInfo.perf" required="true" title="不得少于10个字">${pnRegInfo.perf }</textarea></td>
							<td><font color="red">*</font></td>
						</tr>
					</tbody>
					<tfoot>
