<%@page import="com.wr4.domain.EnRegInfo"%>
...
<%
	...
	EnRegInfo enRegInfo = (EnRegInfo)request.getAttribute("enRegInfo");
...
%>
var bustype='${enRegInfo.bustype}';
var celltype='${enRegInfo.celltype}';
//天津城六区不包含在内
...
$(function(){
 $.ajax({
	    ...
	    success:function(returnValue){
	   	    ...
	   	    for(var i=0;i<obj2.length;i++){
   				if('${enRegInfo.area}'==obj2[i].du_code){
   					str2+='<OPTION selected value='+obj2[i].du_code+'>'+obj2[i].du_name+'</OPTION>';
   				}else{
 ...
 document.getElementById("enRegInfo.bustype").value=bustype;
 showMot(celltype);
 initSelect();
 redirec(bustype);
})
function initSelect(){
	var cc = document.getElementById("enRegInfo.grade");
	 for(var i=0;i<cc.options.length;i++){
	 	if(cc.options[i].value=='${enRegInfo.grade}'){
	...
	var temp = document.getElementById("enRegInfo.celltype");
		for (i = 0; i < select2[x].length; i++) {
			temp.options[i+1] = new Option(select2[x][i].text,
					select2[x][i].value);
			if(celltype == select2[x][i].value){
				temp.options[i+1].selected = true;
			}
		}
...
<body>
	<center style="border: 1px solid #369">
		<h1
			style="padding:20px; background-color:#369; color: white; font-size: 22px; margin-top:0px">企业报名申请信息修改</h1>
		<div align="left">
			<div class="eui-info">
		...
		<div align="center" style="border:0px solid red">
			...
			<form id="fm1" name="frm" method="POST" action="<%=basePath%>/reg/updateenRegAction.action">
				<input type="hidden" id="" name="enRegInfo.id" value="${enRegInfo.id }"/>
				<input type="hidden" id="userid1" name="userid1" value="${enRegInfo.userid }"/>
				<table style="margin-left: 30px">
					<caption style="padding: 5px">
						<h1 align="center">企业报名申请信息修改</h1>
					</caption>
					<tbody>
						<tr>
							<td
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input readonly="readonly"
								...
								required="true" type="text" value="${enRegInfo.pid }"></td>
							<td><font color="red">*</font></td>
						</tr>
						<tr>
							<td
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="enRegInfo.legalp" value="${enRegInfo.legalp }"
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input readonly="readonly"
								class="easyui-validatebox validatebox-text" id="enRegInfo.userid" name="enRegInfo.userid" value="${enRegInfo.userid }"
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="enRegInfo.contact" name="enRegInfo.contact" value="${enRegInfo.contact }" required="true" type="text"></td>
							<td><font color="red">*</font></td>
						</tr>
						<tr>
							<td
							...
							<td style="border-bottom:1px dotted gray"><input readonly="readonly"
								class="easyui-validatebox validatebox-text" id="enRegInfo.cpid" value="${enRegInfo.cpid }"
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="enRegInfo.mobile" value="${enRegInfo.mobile }"
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="enRegInfo.email" value="${enRegInfo.email }"
...
报名申请通过后，可试情况申请多个等级的证书" > 
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="enRegInfo.address" value="${enRegInfo.address }"
						...
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="enRegInfo.tel" name="enRegInfo.tel" value="${enRegInfo.tel }"
								required="true" type="text"></td>
							<td><font color="red">*</font></td>
						</tr>
						<tr>
							...
							<td style="border-bottom:1px dotted gray"><input
								class="easyui-validatebox validatebox-text" id="enRegInfo.tax" name="enRegInfo.tax" value="${enRegInfo.tax }"
								required="true" type="text"></td>
							<td><font color="red">*</font></td>
						</tr>
						<tr>
							<td
								style="font-family:微软雅黑;font-size:14px;vertical-align:center;height:35px;border-bottom:1px dotted gray"><label>归属区域：</label></td>
							<td style="border-bottom:1px dotted gray">
							<%-- <input class="easyui-validatebox validatebox-text" id="enRegInfo.area" name="enRegInfo.area" value="${enRegInfo.area }"
