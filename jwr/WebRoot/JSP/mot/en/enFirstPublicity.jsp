...
<meta http-equiv="description" content="This is my page">
    ...
    //相见ligerGrid.showFilter.js
        ...
        function  initLiger(parms) {
            ...
            { display: '受理结果', name: 'respResult',  align: 'center' ,
            	render: function (item)
                {
            ...
            { display: '审核结果', name: 'auditResult',  align: 'center',
            	render: function (item)
                {
  ...
  function query(){
    ...
    var parms = {ename:ename,entype:entype,grade:grade,resp:resp,respreview:respreview,resprevel:resprevel};
    initLiger(parms);
  }
  function recover(){
       	$("#entype").val("");
