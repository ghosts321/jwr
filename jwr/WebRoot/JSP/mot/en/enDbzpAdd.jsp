...
<form action="" method="post">
	...
	<tfoot>
		...
		<a class="easyui-linkbutton l-btn" href="javascript:esp_get_score()" onclick="" id="undefined">
		     <span class="l-btn-left">
		     	<span class="l-btn-text">计算分数</span>
		     </span>
		</a></td><td>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;自评报告：
		<input class="easyui-validatebox validatebox-text" id="qual*" title="上传文件（doc或者jpg格式）" name="enPFInfo.reportname"  type="hidden" value="">
		<span></span>
		<a class="easyui-linkbutton l-btn"   onclick="itemclick(this.id)" id="qual">
		  <span class="l-btn-left">
			<span class="l-btn-text">上传文件.. </span>
		  </span>
		</a></td><td>
		 <span id="qual_" style="width: 100px;display: none;color:blue;">上传成功</span>
			</td><td>			
